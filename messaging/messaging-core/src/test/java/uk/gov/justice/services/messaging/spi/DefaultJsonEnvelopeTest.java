...
public class DefaultJsonEnvelopeTest {
    ...
    public void shouldThrowExceptionWhenGettingPayloadAsJsonObjectIfPayloadIsJsonNull() throws Exception {
        ...
        assertThat(incompatibleJsonPayloadTypeException.getMessage(), is("The payload of this JsonEnvelope is null and set to JsonValue.NULL which is not a JsonObject. Please call the method 'payload()' instead if your payload is expected to be null. To check for null payloads please call the method 'payloadIsNull()'."));
    }
    ...
    public void shouldThrowExceptionWhenGettingPayloadAsJsonArrayIfPayloadIsJsonNull() throws Exception {
        ...
        assertThat(incompatibleJsonPayloadTypeException.getMessage(), is("The payload of this JsonEnvelope is null and set to JsonValue.NULL which is not a JsonArray. Please call the method 'payload()' instead if your payload is expected to be null. To check for null payloads please call the method 'payloadIsNull()'."));
    }
    ...
    public void shouldThrowExceptionWhenGettingPayloadAsJsonStringIfPayloadIsJsonNull() throws Exception {
        ...
        assertThat(incompatibleJsonPayloadTypeException.getMessage(), is("The payload of this JsonEnvelope is null and set to JsonValue.NULL which is not a JsonString. Please call the method 'payload()' instead if your payload is expected to be null. To check for null payloads please call the method 'payloadIsNull()'."));
    }
    ...
    public void shouldThrowExceptionWhenGettingPayloadAsJsonNumberIfPayloadIsJsonNull() throws Exception {
        ...
        assertThat(incompatibleJsonPayloadTypeException.getMessage(), is("The payload of this JsonEnvelope is null and set to JsonValue.NULL which is not a JsonNumber. Please call the method 'payload()' instead if your payload is expected to be null. To check for null payloads please call the method 'payloadIsNull()'."));
    }
